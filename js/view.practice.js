...
export function render(container) {
  container.innerHTML = `
    <style>
      ...
      .stage { min-height: 180px; display:flex; align-items:center; justify-content:center; margin-bottom: 32px; }
      ...
      /* Limit practice graphics card height so hose doesn't hit header */
      #practiceGraphicCard {
        max-height: 420px;
        overflow: hidden;
      }

      /* Answer card spacing so it doesn't cover truck */
    ...
    <section id="practiceGraphicCard" class="card">
