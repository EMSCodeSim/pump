...
//   • Saved presets list
//   • "Add preset" button
// - Department setup popup (Nozzles, Hoses, Accessories, Line defaults)
...
function renderDeptHomeScreen() {
  ...
  bodyEl.innerHTML = `
    <p class="dept-intro">
      ...
      hoses, common accessories, and line defaults that match your rigs.
    </p>
    <div class="dept-menu">
    ...
    <p class="dept-intro" style="margin-top:8px;">
      Department line defaults
    </p>
    <div class="dept-menu">
      <button type="button" class="btn-secondary dept-line-default-btn" data-line="1">Line 1 default</button>
      <button type="button" class="btn-secondary dept-line-default-btn" data-line="2">Line 2 default</button>
      <button type="button" class="btn-secondary dept-line-default-btn" data-line="3">Line 3 default</button>
    </div>
  `;
  ...
  // New: line defaults entry from dept setup menu
  bodyEl.querySelectorAll('.dept-line-default-btn').forEach(btn => {
...
function renderDeptLineDefaultsScreen(lineNumber) {
  ...
  // Back now returns to the Department setup home screen
  ...
  footerEl.querySelector('#deptLineSaveBtn')?.addEventListener('click', () => {
    ...
    // After saving, go back to Dept setup menu
    renderDeptHomeScreen();
  });
