...
// Preset line editor popup: name + type selection + opens type builders.
...
export function openPresetEditorPopup(options) {
  ...
  typeHint.textContent = "Enter a name, choose a type, then use the type window to set hose/nozzle/etc.";
