...
export const DEPT_NOZZLE_LIBRARY = [
  ...
  // =========================
  // MASTER STREAM FOG (if you use them)
  // =========================
  ...
  // =========================
  // SPECIALTY NOZZLES (HOOK YOUR EXISTING ONES HERE)
  // =========================

  // Example specialty nozzles – replace/merge with your actual ones:
  ...
  // TODO: Paste YOUR actual specialty nozzle definitions here
  // e.g. your current CAFS, bumper line, high-rise pack, etc.
];
