...
#tipEditor .te-row{display:flex !important;flex-direction:column !important;align-items:stretch !important;gap:12px !important;margin:18px 0 !important}
#tipEditor .te-row>label{display:block !important;font-weight:900 !important;font-size:19px !important;color:#eef4ff !important;opacity:1 !important;line-height:1.1 !important;margin:0 0 4px !important}
...
#tipEditor .te-row>select,#tipEditor .te-row>input:not([type="hidden"]),#tipEditor #teWhere{min-height:68px !important;padding:16px 18px !important;font-size:20px !important;border-radius:20px !important;border:1px solid rgba(130,170,255,.26) !important;background:linear-gradient(180deg,#0c1a30 0%,#0b1729 100%) !important;color:#edf3ff !important;font-weight:800 !important;line-height:1.2 !important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 0 0 1px rgba(255,255,255,.02) !important}
#tipEditor .te-row>select{padding-right:40px !important}
#tipEditor .steppers{display:grid !important;grid-template-columns:minmax(88px,1fr) minmax(132px,1.35fr) minmax(88px,1fr) !important;justify-items:stretch !important;align-items:stretch !important;gap:12px !important;background:linear-gradient(180deg,#091a35 0%,#0a1830 100%) !important;border:1px solid rgba(69,121,214,.34) !important;border-radius:26px !important;padding:16px !important;width:100% !important;overflow:hidden !important;box-shadow:inset 0 1px 0 rgba(255,255,255,.05),0 10px 24px rgba(0,0,0,.18) !important}
#tipEditor .steppers.inline-stepper{grid-template-columns:minmax(88px,1fr) minmax(132px,1.35fr) minmax(88px,1fr) !important;grid-template-rows:1fr !important}
#tipEditor .stepBtn{background:linear-gradient(180deg,#253347 0%,#202c3f 100%) !important;border:1px solid rgba(149,178,230,.16) !important;color:#f2f6ff !important;font-weight:900;width:100% !important;min-height:92px !important;font-size:56px !important;line-height:1 !important;border-radius:24px !important;touch-action:manipulation;display:flex !important;align-items:center !important;justify-content:center !important;box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 8px 20px rgba(0,0,0,.12) !important}
#tipEditor .stepBtn:active{transform:translateY(1px)}
#tipEditor .stepVal{display:flex !important;align-items:center !important;justify-content:center !important;min-height:92px !important;padding:10px 14px !important;text-align:center !important;font-weight:900 !important;font-size:36px !important;white-space:nowrap !important;border-radius:24px !important;background:linear-gradient(180deg,#19283f 0%,#142339 100%) !important;border:1px solid rgba(149,178,230,.14) !important;color:#f1f5ff !important;box-shadow:inset 0 1px 0 rgba(255,255,255,.05) !important}
...
@media (max-width:480px){#stageOverlayHost #tipEditor.cover-stage, #tipEditor.is-open{padding:14px !important}#tipEditor .mini{font-size:18px !important}#tipEditor .te-row>label{font-size:18px !important}#tipEditor .te-row>select,#tipEditor .te-row>input:not([type="hidden"]){font-size:19px !important;min-height:64px !important}#tipEditor .steppers.inline-stepper{grid-template-columns:minmax(82px,1fr) minmax(118px,1.25fr) minmax(82px,1fr) !important}#tipEditor .stepBtn{min-height:86px !important;font-size:50px !important;border-radius:22px !important}#tipEditor .stepVal{min-height:86px !important;font-size:34px !important;border-radius:22px !important}}`
    root.appendChild(s);
